		...
		.fs = {
			...
			.fs_avl = {
				[0] = {
					.num = ST_ACCEL_FS_AVL_2G,
					.value = 0x00,
					.gain = IIO_G_TO_M_S_2(15600),	//revisar
				},
				[1] = {
					.num = ST_ACCEL_FS_AVL_16G,
					.value = 0x01,
					.gain = IIO_G_TO_M_S_2(187500),	//revisar
				},
				[2] = {
					.num = ST_ACCEL_FS_AVL_4G,
					.value = 0x02,
					.gain = IIO_G_TO_M_S_2(31200),	//revisar
				},
				[3] = {
					.num = ST_ACCEL_FS_AVL_8G,
					.value = 0x03,
					.gain = IIO_G_TO_M_S_2(62500),	//revisar
				},
			},
		},
		.drdy_irq = {
